 ...
 * IDL can be found at `target/idl/raider.json`.
 */
export type Raider = {
  "address": "FwUNcUaRbYGiWasHa6DA3xQaQJfZWCgH7UhDeBvoJcBv",
  "metadata": {
    "name": "raider",
    "version": "0.1.0",
    "spec": "0.1.0",
