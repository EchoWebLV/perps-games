...
function fakeApi(over: Partial<Api> = {}): Api {
  return {
    ...
    recordTrade: async (input) => ({ ...input, walletPublicKey: "w1", pnlBase: 0, settledAt: "2026-01-01T00:00:00.000Z" }),
    listTrades: async () => ({ items: [], nextCursor: null }),
    bindWalletChallenge: async (wallet) => ({ challenge: "c1", message: "m1", wallet, expiresAt: "2026-01-01T00:00:00.000Z" }),
    bindWallet: async () => ({ wallet: "w1" }),
