 ...
 *  the mode itself lives on for the boot-restore of an open perpetual position. It is the only
 *  parked kind — UPGRADES is back on the ring, and also opens from the garage's collection view. */
